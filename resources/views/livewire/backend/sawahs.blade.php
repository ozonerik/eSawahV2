...
<x-script_lokasi/>
<script>
    window.addEventListener('runCurrencyScript', event => {
    ...
    <div class="row mx-1">
        ...
        <x-card_form name="Add Sawah" width="9" order="1" smallorder="1" closeto="onRead">
            ...
            <form wire:submit.prevent="addsawah">
                ...
                <x-input_currency disabled="" ids="hargabeli" label="Harga Beli (Rp)" types="text" name="hargabeli" placeholder="Type Harga Beli Sawah" />
